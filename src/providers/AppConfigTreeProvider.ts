 ...
 *
 * The one-click dev-mode toggles/status rows (File System Design Mode, VS
 * Code debugging, WorkspaceConsole sync) that used to live at the top of
 * this same tree moved to their own `DevModeTreeProvider`/view — they aren't
 * a file to browse/edit like everything else here, and got lost among what
 * can be a much longer list of real config entries.
 */
